...
const config = {
	"info": {
		...
		"authors": [{
			"name": "niсk",
			"discord_id": "853356105827745802",
			"github_username": "nickrunsyou"
		}],
		"github": "https://github.com/nickrunsyou/",
		"website": "https://discord.gg/customize/",
		"invite": "customize"
	},
	"changelog": [{
		...
		"type": "fixed",
		"items": [
			"This plugin has been rewritten by nick. Functionality is simliar, and settings and data should still be valid.",
	...
	(() => {
		...
		(() => {
			...
			var changelog = [{
				title: "1.0.0 rewrite",
				type: "fixed",
				items: ["This plugin has been rewritten by nick. Functionality is simliar, and settings and data should still be valid.", "If you experience any bugs, please contact me."]
			}];
			var build = {
				zlibrary: true,
				copy: true,
